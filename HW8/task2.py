...
def optimize_model():
    ...
    huber_loss = policy_net(state_batch)[1]
    ...
    next_huber_loss = target_net(non_final_next_states)[1]
...
EPS_DECAY = 200
TARGET_UPDATE = 10
learning_rate = 8 * math.exp(-3)
memory_size = [10000, 30000, 50000]
...
for i in range(3):
    ...
    memory = ReplayMemory(memory_size[i])
